...
class Settings(BaseSettings):
    ...
    # --- Azure DevOps MCP ---
    ado_org_url: str = ""  # e.g. "https://dev.azure.com/myorg"
    ado_project: str = ""  # e.g. "MyProject"
    ado_pat: str = ""  # Personal Access Token (never commit this)
    ...
    ado_golden_qa_path: str = "./data/evaluation/ado_golden_set.json"
